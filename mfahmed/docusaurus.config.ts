...
const config: Config = {
  ...
  tagline: 'A comprehensive textbook on embodied intelligence, simulation workflows, and humanoid control systems',
  ...
  themeConfig: {
    ...
    navbar: {
      ...
      items: [
        ...
        {
          href: 'https://github.com/physical-ai-textbook/robotics-textbook',
          label: 'GitHub',
          position: 'right',
        },
      ],
